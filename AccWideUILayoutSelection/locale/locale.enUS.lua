...
--if (GetLocale() == "enUS") then
	...
	L.ACCWUI_LOAD_FIRST_TIME_CHAR = "This is the first time you have logged in to this character with the Account Wide Interface Option Settings addon installed."
	...
	L.ACCWUI_ADCOM_CURRENT = "Current Settings for %s:"
