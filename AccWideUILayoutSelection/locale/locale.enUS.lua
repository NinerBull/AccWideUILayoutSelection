...
L["ACCWUI_OPT_MODULES_CHK_BLOCKGUILD_DESC"] = "When checked, the options to block or allow Guild Invites is synchronised."
L["ACCWUI_OPT_MODULES_CHK_BLOCKTRADE"] = "Block Trade Request Setting"
L["ACCWUI_OPT_MODULES_CHK_BLOCKTRADE_DESC"] = "When checked, the options to block or allow Trade Requests is synchronised."
L["ACCWUI_OPT_MODULES_CHK_BLOCKCHANNEL"] = "Block Channel Invite Setting"
L["ACCWUI_OPT_MODULES_CHK_BLOCKCHANNEL_DESC"] = "When checked, the options to block or allow Chat Channel Invites is synchronised."
