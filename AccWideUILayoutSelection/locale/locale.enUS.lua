...
L["ACCWUI_OPT_MODULES_CHK_DMGMETER_DESC"] = "When checked, Damage Meter Visibility will be synchronised."
...
L["ACCWUI_OPT_MODULES_CHK_MINIMAP_DESC"] = "When checked, various Minimap settings will be synchronised."
