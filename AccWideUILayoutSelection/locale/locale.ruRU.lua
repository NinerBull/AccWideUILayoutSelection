...
L["ACCWUI_OPT_MODULES_CHK_BAGS_DESC"] = "Если этот флажок установлен, ваши назначения сумок, а также настройки «Игнорировать» и «Продавать мусор» синхронизируются." --Needs Update
...
L["ACCWUI_OPT_MODULES_CHK_CHATPOSITION"] = "Настройки позиции чата"
L["ACCWUI_OPT_MODULES_CHK_CHATPOSITION_DESC"] = "Если этот флажок установлен, расположение окон чата синхронизируется."  -- Needs Update
...
L["ACCWUI_BLOCKBLIZZ_TITLE"] = "Блокировать каналы чата Blizzard"
L["ACCWUI_BLOCKBLIZZ_DESC"] = "Запретить всем персонажам вашей учетной записи присоединяться к различным каналам чата по умолчанию" -- Needs Update
L["ACCWUI_BLOCKBLIZZ_TEXT_DESC"] = "Всем персонажам вашей учетной записи будет запрещено присоединяться к каналам, которые вы отметите ниже.\n\nЕсли вы передумаете, вам придется вручную повторно присоединиться к этим каналам."
L["ACCWUI_BLOCKBLIZZ_CHANNEL"] = "%s " .. CHANNEL
L["ACCWUI_BLOCKBLIZZ_CHECKBOX_DESC"] = "Установка этого флажка не позволит всем вашим персонажам присоединиться к каналу чата %s."
...
L["ACCWUI_DEBUG_DESC"] = "Настройки на этой странице будут применены ко всем профилям вашей учетной записи." -- Needs Update
L["ACCWUI_DEBUG_CHK_SHOWDEBUGOPTIONS"] = "Показать настройки отладки"

L["ACCWUI_DEBUG_CHK_SHOWDEBUGPRINT"] = "Вывод отладочного текста"
